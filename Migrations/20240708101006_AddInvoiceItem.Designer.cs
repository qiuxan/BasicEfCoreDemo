...
namespace BasicEfCoreDemo.Migrations
{
    ...
    [Migration("20240708101006_AddInvoiceItem")]
            ...
            modelBuilder.Entity("BasicEfCoreDemo.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("24e49da1-dd8e-4cba-b3d6-2b57713e7fcb"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("3711bb7d-403b-4223-b37e-f1ab572200a8"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("ae17e2bb-d782-46c9-b57b-da9820105f70"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
