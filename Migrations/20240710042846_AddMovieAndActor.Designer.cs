...
namespace BasicEfCoreDemo.Migrations
{
    ...
    [Migration("20240710042846_AddMovieAndActor")]
            ...
            modelBuilder.Entity("BasicEfCoreDemo.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d265b58e-46d4-45ee-9136-990211418794"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("4ff42daf-6dc1-4d79-9f42-7432e2221fd4"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("5418ff6b-5a6a-4d18-9bf9-d310975aa4e9"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
